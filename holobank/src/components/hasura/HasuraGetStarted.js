...
export default ({
  text = "Families all over Australia build their homes with HoloBank",
  primaryLinkText = "Get Started",
  primaryLinkUrl = "#application-form",
  ...
  return (
    <Container css={pushDownFooter && tw``}>
      <ContentWithPaddingXl tw="pb-0">
      <PrimaryBackgroundContainer tw="h-5">
        <Row tw="h-5">
          <TextContainer>
            <Text>{text}</Text>
          </TextContainer>
