...
const Header = tw(HeaderBase)`flex mx-auto px-8`;
...
export default ({
  heading = "Home Loans for your family.",
  description = "Buying a home is a big decision, regardless of your finances, family, or living situation. At HoloBank, we take away the stress associated with home loans and provide you with fast decisions and simple terms",
  ...
  primaryButtonUrl = "#application-form",
  primaryButtonText = "Get Started",
  buttonRounded = true,
  features = ["Available online & in-branch", "Best rates and terms guaranteed", "99.95% loan approval rating"],
  testimonial = {
    quote: "HoloBank held my hand throughout and made the whole experience from initial application to close an absolute pleasure.",
    customerName: "Charlotte Hale",
    customerCompany: "Melbourne VIC"
  }
}) => {
  ...
  return (
    <div tw="">
      ...
      <Container tw="text-left">
        <ContentWithVerticalPadding tw="mt-0 mb-0 pb-0 pt-0">
          <Row tw="pl-20 pr-20">
            <TextColumn>
